...
function webGLStart() {
    ...
    function faux( a, b, enda, endb ){
        ...
        if( enda ){
            cp1.push( a[0] );
            cp1.push( b[1] > a[1] ? b[1] - dy : a[1] + dy );
            cp1.push( a[2] );//only true in flat
        } else {
            cp1.push( b[0] > a[0] ? b[0] - dx : a[0] + dx );
            cp1.push( a[1] );
            cp1.push( a[2] );//only true in flat
        }
        ...
        if( endb ){
            cp2.push( a[0] );
            cp2.push( b[1] > a[1] ? b[1] - dy : a[1] + dy );
            cp2.push( a[2] );//only true in flat
        } else {
            cp2.push( b[0] > a[0] ? b[0] - dx : a[0] + dx );
            cp2.push( a[1] );
            cp2.push( a[2] );//only true in flat
        }
